...
def analyze_route(symbol):
    try:
        ...
        if returns:
            ...
            statistics = [{
                'week_number': str(current_week_num),  # Plain number as string, no "W"
            ...
            statistics = [{
                'week_number': str(current_week_num),  # Plain number as string
                'count': 0,
                'avg_return': 0,
                'pct_profitable': 0,
                'profit_factor': 0,
        ...
        current_info = {
            'current_week': str(current_week_num),  # Plain number as string
        ...
        for week in current_week_data:
            history.append({
                'week_number': str(week['week_number']),  # Plain number as string
                'year': week['year'],
